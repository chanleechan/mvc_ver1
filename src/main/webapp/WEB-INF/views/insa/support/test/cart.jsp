...
<form method="post" action="http://localhost:8070/pugis/test/saveMenu" name="userinput" onSubmit="return checkIt()">
<div id="wrap">
   ...
   <div class="form">
	...
	<td colspan = "3"  style="color:gray">장바구니</td>
		...
		<c:forEach var="searchResultItem" items="${b_List}"> 
				    <tbody id = "book_List">
					    <tr align = "center" bgcolor="white">
							<td id = "book_name" style="color:gray">${searchResultItem.book_name}
							<input type = "hidden" name = "book_name" value = "${searchResultItem.book_name}">
							</td>
							<td id = "book_price" style="color:gray">${searchResultItem.book_price}
		...
		<c:forEach var="searchResultItem" items="${b_appList}"> 
				    <tbody id = "b_app_List">
					    <tr align = "center" bgcolor="white">
							<td id = "b_app_name" style="color:gray">${searchResultItem.b_app_name}
								<input type="hidden" name ="b_app_name" value = "${searchResultItem.b_app_name}">
							</td>
							<td id = "b_app_price" style="color:gray">${searchResultItem.b_price}
...
<center><input type="submit" value="담   기">
<input type="button" value = "뒤로가기" onclick = "location.href='http://localhost:8070/pugis/test/serviceMain'">
</center>
</div>
</div>
</div>
