		...
		<div id="wrap">
		   ...
		   <div class="form">
			...
			<table border="1" bordercolor="white" width ="470" height="200" align = "center" >
		     	...
		     	<c:forEach var="h_app" items="${sessionScope}">
					...
					<tr align = "center" bgcolor="white">
						...
						<td id = "h_app_price" style="color:gray">${sessionScope.hprice}
						
						</td>
						<td id = "h_app_amount" style="color:gray">${sessionScope.hcode}
						
						</td>
						<td><input type = "text"  style="width:50px" id = "buyCount" class = "buyCount" value = "<%=session.getAttribute("hname")%>"></td>
						<td><input  type='checkbox' name = "h_appcheck">
					 
						</td>
				    </tr>
				</c:forEach>
		    </table>
		<center><input type="submit" value="저   장" id = "selectBtn2"><input type="button" value = "저장1" id = "selectBtn" onclick = "func1()"></center>
						</div>
					</div>
				</div>
			</div>
