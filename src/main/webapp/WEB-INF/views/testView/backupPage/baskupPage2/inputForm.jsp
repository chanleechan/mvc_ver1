...
<script type="text/javascript">
	...
	function openConfirmid(userinput){
		...
		url="http://localhost:8070/pugis/service/confirmId?emp_id="+userinput.emp_id.value;
...
<form method="post" action="http://localhost:8070/pugis/service/inputPro" name="userinput" onSubmit="return checkIt()">
<div id="wrap">
