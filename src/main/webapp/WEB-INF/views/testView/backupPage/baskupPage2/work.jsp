		   ...
		   <div class="form">
			...
			<table border="1" bordercolor="white" width ="470" height="200" align = "center" >
			    ...
			    <c:forEach var="searchResultItem" items="${searchResultList}"> 
					...
					<tr align = "center" bgcolor="white">
						<td  id = "b_app_name" style="color:gray">${searchResultItem.h_app_name}</td>
						<td  id = "b_app_price" style="color:gray">${searchResultItem.h_price}</td>
						<td  id = "b_app_price" style="color:gray">${searchResultItem.h_price}</td>
