		...
		<c:forEach var="searchResultItem" items="${b_List}"> 
				    <tbody id = "book_List">
					    <tr align = "center" bgcolor="white">
							...
							<td>
								<input  type='checkbox' name = "payMenu" value = "${searchResultItem.book_name}">
							</td>
					    </tr>
				    </tbody>
		</c:forEach>
		<c:forEach var="searchResultItem" items="${b_appList}"> 
				    <tbody id = "b_app_List">
					    <tr align = "center" bgcolor="white">
							...
							<td>
								<input  type='checkbox' name = "payMenu" value = "${searchResultItem.b_app_name}">
							</td>
					    </tr>
				    </tbody>
		</c:forEach>
...
<input type="button" value = "뒤로가기" onclick = "location.href='http://localhost:8070/pugis/total/login'">
</center>
</div>
</div>
</div>
