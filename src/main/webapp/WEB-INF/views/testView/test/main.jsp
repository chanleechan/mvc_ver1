...
<form action="http://localhost:8070/pugis/test/loginPro" method ="post" name="loginform">
  <div id="wrap">
   ...
   <div class="form">
    <div class="form2">
     ...
     <div class="form4">
      <div class="clear"></div>
      <label><input type="button" value="회원등록" onclick="location.href='http://localhost:8070/pugis/test/inputform'"></label> 
