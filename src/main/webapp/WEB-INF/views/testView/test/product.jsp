...
<table align="center">
	<tr><td>
		<form method="post" action="http://localhost:8070/pugis/test/basketList" name="userinput" >
		<div id="wrap">
		...
		<center><input type="submit" value="저   장" id = "selectBtn2"><input type="button" value = "뒤로가기" id = "selectBtn" onclick="location.href='http://localhost:8070/pugis/test/serviceMain'"></center>
						</div>
					</div>
				</div>
			</div>
