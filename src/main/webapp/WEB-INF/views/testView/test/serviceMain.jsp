   ...
   <div class="form">
    <div class="form2">
     <div class="form3">
		...
		<div class = "clear"></div>
		<label><input type="button" value="상품목록" onclick="location.href='http://localhost:8070/pugis/test/product'"></label>
		<label><input type="button" value="장바구니" onclick="location.href='http://localhost:8070/pugis/test/basket'"></label>
