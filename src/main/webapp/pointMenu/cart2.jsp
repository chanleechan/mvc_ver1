...
<div id="wrap">
   ...
   <div class="form">
	...
	<td colspan = "3"  style="color:gray">장바구니</td>
		...
		<c:forEach var="searchResultItem2" items="${searchResultList2}"> 
				    <tbody id = "b_app_List">
					    <tr align = "center" bgcolor="white">
							<td id = "b_app_name" style="color:gray">${searchResultItem2.b_app_name}
								
							</td>
							<td id = "b_app_price" style="color:gray">${searchResultItem2.b_price}
							...
							<td>
								<input  type='checkbox' name = "payMenu" value = "${searchResultItem2.b_app_name}">
							</td>
					    </tr>
				    </tbody>
		</c:forEach>
				<c:forEach var="searchResultItem3" items="${searchResultList3}"> 
				    <tbody id = "book_List">
					    <tr align = "center" bgcolor="white">
							<td id = "book_name" style="color:gray">${searchResultItem3.book_name}
								
							</td>
							<td id = "book_price" style="color:gray">${searchResultItem3.book_price}
							...
							<td>
								<input  type='checkbox' name = "payMenu" value = "${searchResultItem3.book_name}">
							</td>
					    </tr>
				    </tbody>
		</c:forEach>
